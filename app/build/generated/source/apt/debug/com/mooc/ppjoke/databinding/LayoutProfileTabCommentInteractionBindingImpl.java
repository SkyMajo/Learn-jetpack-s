...
public class LayoutProfileTabCommentInteractionBindingImpl extends LayoutProfileTabCommentInteractionBinding implements com.mooc.ppjoke.generated.callback.OnClickListener.Listener {
    ...
    private LayoutProfileTabCommentInteractionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback7 = new com.mooc.ppjoke.generated.callback.OnClickListener(this, 2);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x77L) != 0) {
                ...
                updateRegistration(2, feedTopComment);
                ...
                updateRegistration(1, feedTopCommentUgc);
        ...
        if ((dirtyFlags & 0x40L) != 0) {
            ...
            this.like.setOnClickListener(mCallback6);
            this.share.setOnClickListener(mCallback7);
        }
        if ((dirtyFlags & 0x57L) != 0) {
            // api target 1
    ...
    /* flag mapping
        flag 0 (0x1L): feed
        flag 1 (0x2L): feed.topComment.ugc
        flag 2 (0x3L): feed.topComment
        flag 3 (0x4L): lifeCycleOwner
        flag 4 (0x5L): feed.topComment.ugc.hasLiked
        flag 5 (0x6L): feed.topComment.ugc.shareCount
        flag 6 (0x7L): null
        flag 7 (0x8L): feed.topComment.ugc.hasLiked ? @android:drawable/icon_cell_liked : @android:drawable/icon_cell_like
        flag 8 (0x9L): feed.topComment.ugc.hasLiked ? @android:drawable/icon_cell_liked : @android:drawable/icon_cell_like
        flag 9 (0xaL): feed.topComment.ugc.commentCount > 0 ? StringConvert.convertFeedUgc(feed.topComment.ugc.commentCount) : @android:string/feed_comment
        flag 10 (0xbL): feed.topComment.ugc.commentCount > 0 ? StringConvert.convertFeedUgc(feed.topComment.ugc.commentCount) : @android:string/feed_comment
        flag 11 (0xcL): feed.topComment.ugc.hasLiked ? @android:color/color_theme : @android:color/color_3d3
        flag 12 (0xdL): feed.topComment.ugc.hasLiked ? @android:color/color_theme : @android:color/color_3d3
        flag 13 (0xeL): feed.topComment.ugc.likeCount > 0 ? StringConvert.convertFeedUgc(feed.topComment.ugc.likeCount) : @android:string/like
        flag 14 (0xfL): feed.topComment.ugc.likeCount > 0 ? StringConvert.convertFeedUgc(feed.topComment.ugc.likeCount) : @android:string/like
        flag 15 (0x10L): feed.topComment.ugc.shareCount > 0 ? StringConvert.convertFeedUgc(feed.topComment.ugc.shareCount) : @android:string/share
        flag 16 (0x11L): feed.topComment.ugc.shareCount > 0 ? StringConvert.convertFeedUgc(feed.topComment.ugc.shareCount) : @android:string/share
    flag mapping end*/
    //end
}