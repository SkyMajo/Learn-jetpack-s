...
public class LayoutFeedInteractionBindingImpl extends LayoutFeedInteractionBinding implements com.mooc.ppjoke.generated.callback.OnClickListener.Listener {
    ...
    private LayoutFeedInteractionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        mCallback3 = new com.mooc.ppjoke.generated.callback.OnClickListener(this, 3);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x40L) != 0) {
            ...
            this.diss.setOnClickListener(mCallback2);
            this.like.setOnClickListener(mCallback1);
            this.share.setOnClickListener(mCallback3);
        }
        if ((dirtyFlags & 0x53L) != 0) {
            // api target 1
    ...
    /* flag mapping
        ...
        flag 9 (0xaL): feed.ugc.hasLiked ? @android:color/color_theme : @android:color/color_3d3
        flag 10 (0xbL): feed.ugc.hasLiked ? @android:color/color_theme : @android:color/color_3d3
        flag 11 (0xcL): feed.ugc.likeCount > 0 ? StringConvert.convertFeedUgc(feed.ugc.likeCount) : @android:string/like
        flag 12 (0xdL): feed.ugc.likeCount > 0 ? StringConvert.convertFeedUgc(feed.ugc.likeCount) : @android:string/like
        flag 13 (0xeL): feed.ugc.hasLiked ? @android:drawable/icon_cell_liked : @android:drawable/icon_cell_like
        flag 14 (0xfL): feed.ugc.hasLiked ? @android:drawable/icon_cell_liked : @android:drawable/icon_cell_like
