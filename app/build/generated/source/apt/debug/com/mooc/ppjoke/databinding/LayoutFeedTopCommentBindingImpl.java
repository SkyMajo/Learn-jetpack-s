...
public class LayoutFeedTopCommentBindingImpl extends LayoutFeedTopCommentBinding implements com.mooc.ppjoke.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x37L) != 0) {
            ...
            if ((dirtyFlags & 0x23L) != 0) {
                    ...
                    updateRegistration(0, commentAuthor);
            ...
            if ((dirtyFlags & 0x36L) != 0) {
                    ...
                    updateRegistration(2, commentUgc);
    ...
    /* flag mapping
        flag 0 (0x1L): comment.author
        flag 1 (0x2L): comment
        flag 2 (0x3L): comment.ugc
        flag 3 (0x4L): lifeCycleOwner
        flag 4 (0x5L): comment.ugc.hasLiked
        flag 5 (0x6L): null
        flag 6 (0x7L): comment.ugc.hasLiked ? @android:drawable/icon_cell_liked : @android:drawable/icon_cell_like
        flag 7 (0x8L): comment.ugc.hasLiked ? @android:drawable/icon_cell_liked : @android:drawable/icon_cell_like
        flag 8 (0x9L): TextUtils.isEmpty(comment.commentText) ? View.GONE : View.VISIBLE
        flag 9 (0xaL): TextUtils.isEmpty(comment.commentText) ? View.GONE : View.VISIBLE
        flag 10 (0xbL): comment == null ? View.GONE : View.VISIBLE
        flag 11 (0xcL): comment == null ? View.GONE : View.VISIBLE
        flag 12 (0xdL): TextUtils.isEmpty(comment.videoUrl) ? View.GONE : View.VISIBLE
        flag 13 (0xeL): TextUtils.isEmpty(comment.videoUrl) ? View.GONE : View.VISIBLE
        flag 14 (0xfL): comment.ugc.hasLiked ? @android:color/color_theme : @android:color/color_3d3
        flag 15 (0x10L): comment.ugc.hasLiked ? @android:color/color_theme : @android:color/color_3d3
        flag 16 (0x11L): comment.ugc.likeCount > 0 ? StringConvert.convertFeedUgc(comment.ugc.likeCount) : null
        flag 17 (0x12L): comment.ugc.likeCount > 0 ? StringConvert.convertFeedUgc(comment.ugc.likeCount) : null
        flag 18 (0x13L): TextUtils.isEmpty(comment.imageUrl) ? View.GONE : View.VISIBLE
        flag 19 (0x14L): TextUtils.isEmpty(comment.imageUrl) ? View.GONE : View.VISIBLE
    flag mapping end*/
    //end
}