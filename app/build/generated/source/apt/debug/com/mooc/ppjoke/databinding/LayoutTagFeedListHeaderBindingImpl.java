...
public class LayoutTagFeedListHeaderBindingImpl extends LayoutTagFeedListHeaderBinding implements com.mooc.ppjoke.generated.callback.OnClickListener.Listener {
    ...
    private LayoutTagFeedListHeaderBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback12 = new com.mooc.ppjoke.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x8L) != 0) {
            ...
            this.headerFollow.setOnClickListener(mCallback12);
        }
        if ((dirtyFlags & 0xdL) != 0) {
            // api target 1
    ...
    /* flag mapping
        ...
        flag 7 (0x8L): tagList.hasFollow ? @android:string/tag_follow : @android:string/tag_unfollow
        flag 8 (0x9L): tagList.enterNum > 0 ? View.VISIBLE : View.GONE
        flag 9 (0xaL): tagList.enterNum > 0 ? View.VISIBLE : View.GONE
    flag mapping end*/
    //end
}