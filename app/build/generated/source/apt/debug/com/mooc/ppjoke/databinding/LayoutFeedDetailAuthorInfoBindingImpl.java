...
public class LayoutFeedDetailAuthorInfoBindingImpl extends LayoutFeedDetailAuthorInfoBinding implements com.mooc.ppjoke.generated.callback.OnClickListener.Listener {
    ...
    private LayoutFeedDetailAuthorInfoBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback13 = new com.mooc.ppjoke.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    /* flag mapping
        ...
        flag 6 (0x7L): null
        flag 7 (0x8L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/transparent
        flag 8 (0x9L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/transparent
        flag 9 (0xaL): feed.author.hasFollow ? @android:string/has_follow : @android:string/unfollow
        flag 10 (0xbL): feed.author.hasFollow ? @android:string/has_follow : @android:string/unfollow
        flag 11 (0xcL): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_000
        flag 12 (0xdL): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_000
        flag 13 (0xeL): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_000
        flag 14 (0xfL): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_000
        flag 15 (0x10L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/transparent : @android:color/color_theme
        flag 16 (0x11L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/transparent : @android:color/color_theme
    flag mapping end*/
    //end
}