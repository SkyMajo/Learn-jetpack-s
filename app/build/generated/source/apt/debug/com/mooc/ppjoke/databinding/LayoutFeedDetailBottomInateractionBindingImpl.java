...
public class LayoutFeedDetailBottomInateractionBindingImpl extends LayoutFeedDetailBottomInateractionBinding implements com.mooc.ppjoke.generated.callback.OnClickListener.Listener {
    ...
    private LayoutFeedDetailBottomInateractionBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback9 = new com.mooc.ppjoke.generated.callback.OnClickListener(this, 2);
        mCallback8 = new com.mooc.ppjoke.generated.callback.OnClickListener(this, 1);
        mCallback10 = new com.mooc.ppjoke.generated.callback.OnClickListener(this, 3);
        invalidateAll();
    }
    ...
    /* flag mapping
        ...
        flag 9 (0xaL): feed.ugc.hasLiked ? @android:drawable/icon_cell_liked : @android:drawable/icon_cell_like
        flag 10 (0xbL): feed.ugc.hasLiked ? @android:drawable/icon_cell_liked : @android:drawable/icon_cell_like
        flag 11 (0xcL): feed.ugc.likeCount > 0 ? String.valueOf(feed.ugc.likeCount) : @android:string/like
        flag 12 (0xdL): feed.ugc.likeCount > 0 ? String.valueOf(feed.ugc.likeCount) : @android:string/like
        flag 13 (0xeL): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 14 (0xfL): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 15 (0x10L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/transparent : @android:color/color_white
        flag 16 (0x11L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/transparent : @android:color/color_white
        flag 17 (0x12L): feed.ugc.hasFavorite ? @android:drawable/ic_collected : @android:drawable/ic_collect
        flag 18 (0x13L): feed.ugc.hasFavorite ? @android:drawable/ic_collected : @android:drawable/ic_collect
        ...
        flag 21 (0x16L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 22 (0x17L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 23 (0x18L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 24 (0x19L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        ...
        flag 27 (0x1cL): feed.ugc.hasLiked ? @android:color/color_theme : androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 28 (0x1dL): feed.ugc.hasLiked ? @android:color/color_theme : androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 29 (0x1eL): feed.ugc.hasLiked ? @android:color/color_theme : androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 30 (0x1fL): feed.ugc.hasLiked ? @android:color/color_theme : androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 31 (0x20L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 32 (0x21L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 33 (0x22L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? View.INVISIBLE : View.VISIBLE
        flag 34 (0x23L): androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? View.INVISIBLE : View.VISIBLE
        flag 35 (0x24L): feed.ugc.hasFavorite ? @android:color/color_theme : androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 36 (0x25L): feed.ugc.hasFavorite ? @android:color/color_theme : androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 37 (0x26L): feed.ugc.hasFavorite ? @android:color/color_theme : androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 38 (0x27L): feed.ugc.hasFavorite ? @android:color/color_theme : androidx.databinding.ViewDataBinding.safeUnbox(fullscreen) ? @android:color/color_white : @android:color/color_666
        flag 39 (0x28L): feed.ugc.hasFavorite ? @android:string/has_collect : @android:string/collect
        flag 40 (0x29L): feed.ugc.hasFavorite ? @android:string/has_collect : @android:string/collect
    flag mapping end*/
    //end
}