...
public class ActivityFeedDetailTypeImageBindingImpl extends ActivityFeedDetailTypeImageBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {3},
            new int[] {R.layout.layout_feed_detail_bottom_inateraction});
        sIncludes.setIncludes(1, 
            new String[] {"layout_feed_detail_author_info"},
            new int[] {2},
            new int[] {R.layout.layout_feed_detail_author_info});
    ...
    /* flag mapping
        flag 0 (0x1L): feed
        flag 1 (0x2L): interactionLayout
        flag 2 (0x3L): authorInfoLayout
        flag 3 (0x4L): null
    flag mapping end*/
    //end
}