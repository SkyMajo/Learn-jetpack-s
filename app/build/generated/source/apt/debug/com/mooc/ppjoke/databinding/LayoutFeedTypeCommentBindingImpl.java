...
public class LayoutFeedTypeCommentBindingImpl extends LayoutFeedTypeCommentBinding  {
    ...
    static {
        ...
        sIncludes.setIncludes(0, 
            ...
            new int[] {4, 5, 6, 7},
            new int[] {R.layout.layout_feed_author, R.layout.layout_feed_text, R.layout.layout_feed_tag, R.layout.layout_profile_tab_comment_interaction});
        sViewsWithIds = null;
    }
    // views
    @Nullable
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x2bL) != 0) {
            ...
            if ((dirtyFlags & 0x21L) != 0) {
                ...
                updateRegistration(1, feedTopCommentAuthor);
    ...
    /* flag mapping
        flag 0 (0x1L): feed
        flag 1 (0x2L): feed.topComment.author
